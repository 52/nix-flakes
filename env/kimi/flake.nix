{
  description = "Development environment flake for Kimi";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        ##
        #@ Package
        kimi = pkgs.writeShellApplication {
          name = "kimi";
          ...
          text = ''
            exec ${pkgs.bubblewrap}/bin/bwrap \
              ...
              --die-with-parent \
              --chdir "$PWD" \
              ${llm-agents.packages.${system}.kimi-code}/bin/kimi \
              --yolo "$@"
          '';
        };
      in
